...
import com.ticketcorner.movieticketbooking.application.thread.VendorThread;
...
public class VendorService extends UserService {
    ...
    public List<UserDTO> getAllUsers() {
        List<User> vendors = userRepository.findUsersByRole(UserRoleEnum.ROLE_VENDOR);
    ...
    public UserDTO getUserByUserId(String userId) {
        User existVendor = userRepository.findUserByRoleAndUserId(UserRoleEnum.ROLE_CUSTOMER, userId)
    ...
    public UserDTO updateUser(String userId, UserDTO userDTO) {
        User existingVendor = userRepository.findUserByRoleAndUserId(UserRoleEnum.ROLE_VENDOR, userId)
                .orElseThrow(() -> new UserNotFoundException("Vendor not found with the id: " + userId));
    ...
    public void deleteUser(String userId) {
        User existVendor = userRepository.findUserByRoleAndUserId(UserRoleEnum.ROLE_VENDOR, userId)
                .orElseThrow(() -> new UserNotFoundException("Vendor not found with the id: " + userId));
