...
import com.ticketcorner.movieticketbooking.common.exceptions.MovieNotFoundException;
import com.ticketcorner.movieticketbooking.common.exceptions.TicketAlreadyExistsException;
import com.ticketcorner.movieticketbooking.common.exceptions.TicketNotFoundException;
import com.ticketcorner.movieticketbooking.common.exceptions.UserNotFoundException;
import com.ticketcorner.movieticketbooking.common.mappers.TicketMapper;
...
import com.ticketcorner.movieticketbooking.domain.movie.repository.MovieRepository;
import com.ticketcorner.movieticketbooking.domain.ticket.repository.TicketRepository;
...
public class TicketServiceImpl implements TicketService {
    ...
    private User findVendorById(String vendorId) {
        return userRepository.findUserByRoleAndUserId(UserRoleEnum.ROLE_VENDOR, vendorId)
